...
use Pacificnm\Auth\Controller\UpdateController;
...
class UpdateControllerFactory
{
     ...
     * @return \Pacificnm\Auth\Controller\UpdateController
     */
    public function __invoke(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $form = $realServiceLocator->get('Pacificnm\Auth\Form\Form');
        
        $profileForm = $realServiceLocator->get('Pacificnm\Auth\Form\ProfileForm');
